...
- **Blender 5.0** or later — [download here](https://www.blender.org/download/)
- Windows, macOS, or Linux

## Install from Disk

1. Download the latest release `.zip` [Here](https://creativedesigner3d.wordpress.com/wp-content/uploads/2026/02/home_builder_5_beta1.zip)
2. Open Blender
...
![alt text](images/Home_Builder_Panel.png)